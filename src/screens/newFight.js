            ...
            if(!activeTextBoxRef.current){
                ...
                if (e.code === "ArrowRight") {
                    if(!playingRef.current){
                        playerRef.current.seekTo(progressRef.current[playIndexRef.current] + 0.1)
                        progressRef.current[playIndexRef.current] = progressRef.current[playIndexRef.current] + 0.1
                    }else{
